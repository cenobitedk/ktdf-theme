...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-meta">
		...
		<span class="comments-meta"><a href="<?php the_permalink(); ?>#respond"><?php comments_number(__( 'Leave a Comment', 'darkgritty' ), __( '1 Comment', 'darkgritty' ), __( '% Comments', 'darkgritty' )); ?></a></span>
	</div>
</div>
<?php 
