...
<div class="gigpress-table <?php echo $scope; ?>">
	<div>
		<div class="gigpress-header">
			<span scope="col" class="gigpress-date"><?php _e("Date", "gigpress"); ?></span>
		<?php if( (!$artist && $group_artists == 'no') && $total_artists > 1) : ?>
			<span scope="col" class="gigpress-artist"><?php echo wptexturize($gpo['artist_label']); ?></span>
		<?php endif; ?>
			<span scope="col" class="gigpress-city"><?php _e("City", "gigpress"); ?></span>
			<span scope="col" class="gigpress-venue<?php if($venue) : ?> hide<?php endif; ?>"><?php _e("Venue", "gigpress"); ?></span>
		<?php if($gpo['display_country'] == 1) : ?>
			<span scope="col" class="gigpress-country"><?php _e("Country", "gigpress"); ?></span>
		<?php endif; ?>
		</div>
	</div>
