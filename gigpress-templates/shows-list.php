...
<div class="gigpress-table upcoming">

	<div class="vevent">

		<div class="gigpress-row <?php echo $class; ?>">

			<div class="gigpress-left">

				<div class="gigpress-venue-meta">

					<span class="gigpress-city summary">
						<span class="hide"><?php echo $showdata['artist']; ?> <?php _e("in", "gigpress"); ?> </span>
						<?php echo $showdata['city']; ?>
					</span>

					<?php if($gpo['display_country'] == 1) : ?>
						<span class="gigpress-country">
							<?php echo $showdata['country']; ?>
						</span>
					<?php endif; ?>

					<span class="gigpress-venue location<?php if($venue) : ?> hide<?php endif; ?>">
						<?php echo $showdata['venue']; ?>
					</span>

				</div>

				<div class="gigpress-info <?php echo $class; ?>">

					<div class="gigpress-links-cell">
